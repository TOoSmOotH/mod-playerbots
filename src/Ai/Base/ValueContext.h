...
#include "Value.h"
#include "Ai/World/Rpg/Value/QuestTargetValue.h"
...
public:
    ValueContext()
    {
        ...
        creators["quest target"] = &ValueContext::quest_target;
...
private:
    ...
    static UntypedValue* quest_target(PlayerbotAI* botAI) { return new QuestTargetValue(botAI); }
